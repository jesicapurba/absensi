...
<div class="bg-white rounded-lg shadow-md p-6 max-w-3xl mx-auto">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Edit Data Siswa</h2>
    ...
    <form action="{{ route('siswa.update', $siswa) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
                ...
                <input type="text" name="nis" id="nis" value="{{ $siswa->nis }}" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ $siswa->name }}" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
            ...
            <div>
                ...
                <input type="text" name="asal_sekolah" id="asal_sekolah" value="{{ $siswa->asal_sekolah }}" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
