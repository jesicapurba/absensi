...
<div class="container">
    ...
    <a href="{{ route('presensi.index') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center">
            <i class="fas fa-plus mr-2"></i> Kembali
    </a><br><br>
    <div class="card mb-3">Presensi Siswa</div>
        <div class="card-body">
